    ...
    <div class="container-fluid img">
        <div class="row d-flex justify-content-center   h-100  align-items-center">
            <div class="col-12 col-sm-9 col-lg-5 shadow-sm p-3 mb-5 bg-blue-oscuro rounded animated slideInDown p-5">
               ...
               <h1 class="display-5 text-center text-white">INICIAR SESION</h1>
               <!-- <div class="alert alert-danger mt-5">El usuario no existe</div> -->
                <form  class="form-group " id="form-sesion" >
                        ...
                        <div class="input-group mb-2 mt-4 py-3">
                          ...
                          <input type="text" class="form-control rounded-0 py-3" name="N_identificacion" id="inlineFormInputGroupUsername2" placeholder="N documento">
                        </div>
                    ...
                    <div class="input-group mb-0 mt-2 py-3">
                      ...
                      <input type="password" name="Password" class="form-control rounded-0 py-3" id="inlineFormInputGroupUsername2" placeholder="Password">
                    </div>
